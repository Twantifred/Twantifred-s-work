...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+3,"ALUctr", false,-1, 2,0);
    tracep->declBus(c+4,"ALUout", false,-1, 3,0);
    tracep->declBus(c+5,"temp", false,-1, 3,0);
    tracep->declBit(c+6,"less", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+3,(vlSelf->ALUctr),3);
    bufp->fullCData(oldp+4,(vlSelf->ALUout),4);
    bufp->fullCData(oldp+5,(vlSelf->temp),4);
    bufp->fullBit(oldp+6,(vlSelf->less));
    bufp->fullBit(oldp+7,(vlSelf->of));
    bufp->fullBit(oldp+8,(vlSelf->zf));
